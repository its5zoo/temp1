...
export default function JobApplyPage() {
  ...
  if (!job) {
    return <div className="p-12 text-center text-slate-500">Job position not found.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-16 max-w-3xl mt-12">
        <Link to="/careers" className="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium mb-8">
