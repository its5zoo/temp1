    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">
                Weekly Class Timetable & Lab Slots
              </h2>
              <p className="text-xs text-slate-500 mt-0.5">
                Semester 5 Section A • Lecture Halls, Lab Practicums & Seminar Blocks
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredSlots.map((slot, idx) => (
          ...
          >
            <div>
              ...
              <h3 className="text-sm font-extrabold text-slate-900 mt-2">{slot.course}</h3>
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 space-y-1.5 text-xs text-slate-600 font-medium">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-slate-900 font-semibold">{slot.instructor}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {filteredSlots.length === 0 && (
          <div className="col-span-3 bg-white rounded-2xl p-12 text-center border border-slate-200 text-slate-400 text-xs">
