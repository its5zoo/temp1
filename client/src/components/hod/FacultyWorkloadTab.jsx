    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-sky-100 shadow-2xs">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Live distribution of lecture credits and laboratory sessions.</p>
        </div>
              ...
              <div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-extrabold text-slate-900 text-sm leading-snug">{f.name}</h4>
                ...
                <div className="flex items-center gap-2 mt-4 text-xs font-medium">
                  <span className="px-2 py-0.5 rounded-md bg-sky-50 text-sky-900 font-bold border border-sky-200">
                    {f.type}
                  </span>
                ...
                <div className="mt-4 p-4 rounded-xl bg-sky-50/40 border border-sky-100">
                  ...
                  <div className="flex justify-between items-center text-xs text-slate-500 font-medium mt-2">
                    <span>Workload Score: {f.workloadScore} pts</span>
                    ...
                    f.assignedCourses.map((c) => (
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-xs text-slate-900 bg-white border border-slate-200 px-2 py-0.2 rounded">{c.code}</span>
                            <span className="text-xs text-sky-900 bg-sky-50 border border-sky-200 px-2 py-0.2 rounded font-bold">
                              {c.section}
                            </span>
                          </div>
                          <p className="text-xs text-slate-700 font-medium truncate mt-1">{c.title}</p>
                        </div>
